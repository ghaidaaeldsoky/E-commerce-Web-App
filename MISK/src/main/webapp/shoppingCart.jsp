                    ...
                    <tr class="product-row">
                      <td>
                        <div class="media">
                          ...
                          <div class="media-body">
                            ...
                            <a href="#" style="font-size: 12px" class="removeitem">remove item</a>
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td>
                        <div class="product_count">
                          <input type="hidden" id="hidden" value="${product.productId}" />
                          <input type="text" name="qty" maxlength="12" value="${product.quantity}" title="Quantity:"
                            class="input-text qty" data-max="${product.storage}" readonly />
                  ...
                  <tr class="out_button_area">
                    ...
                    <td>
                      <div class="checkout_btn_inner d-flex align-items-center">
                        <form id="cartForm">
                          <button type="button" class="primary-btn ml-2" onclick=" submitForm('home',event)"
                            style="margin:4px">
                            Continue Shopping
                          </button>

                          <button type="button" class="primary-btn ml-2 xyz" id="proceedtocheckout"
                            onclick=" submitForm('checkoutServlet',event)" style="margin:4px">
                            Proceed to Checkout
                          </button>
                        </form>
                      </div>
