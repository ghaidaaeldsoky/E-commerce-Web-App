      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <div class="navbar-brand-wrapper">
            <a class="navbar-brand brand-logo" href="indexAdmin.html"><img src="img/logo.svg" alt="logo"/></a>
            <a class="navbar-brand brand-logo-mini" href="indexAdmin.html"><img src="img/logo-mini.svg" alt="logo"/></a>
          </div>
